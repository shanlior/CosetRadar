function sim_SNRHitRateFISTA_graphs(g_LPF, SNR_dB_all, hit_rate, rms_t, bias_t, rms_f, bias_f)
...
legend('NU SubNyq 100/100 FISTA', 'NU SubNyq 50/100 FISTA', ...
       'NU SubNyq 20/100 FISTA', 'NU SubNyq 10/100 FISTA');
xlabel('SNR [dB]');
grid on;
