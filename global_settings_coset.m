function [g] = global_settings_coset(nu_pulses, P, L, snr_db, sample_SubNyquist_factor, pulse_SubNyquist_factor, ...
    random_fourier_coeffs, fixed_target_amplitudes,Ci,Q)
